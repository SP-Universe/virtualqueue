    ...
    function waitingUser($guestid){
        ?>
            <div class="placeinline_block" id="placeinline_before" style="visibility: hidden;">
                ...
                <h3 id="estimated_time">(OLD)Vorraussichtlicher Einlass: <?php echo substr(get_data_from_group(get_data_from_guest($guestid, "groupid"), "time"), 0 ,-3); ?></h3>
                <p>(Bitte 5 Minuten vor Einlass am Eingang einfinden)</p>
                <p>
